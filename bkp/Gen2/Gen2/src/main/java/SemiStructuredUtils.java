...
public class SemiStructuredUtils {
...
//            System.out.println("Before: "+parser.getDetectedFormat());
        //    if(parser.getDetectedFormat().getLineSeparatorString().equals("\r")) {
//                System.out.println("in");
//                settings.setLineSeparatorDetectionEnabled(false);
//                settings.getFormat().setLineSeparator("\r\n");
//                CsvFormat csvFormat = settings.getFormat();
//                parser.updateFormat(csvFormat);
           // }
//            System.out.println("After: "+parser.getDetectedFormat());
            allRecords = parser.parseAllRecords(inputStream);
              parser.stopParsing();
        }
        List<HashMap<String, Object>> columnMetainfo = new ArrayList<>();
